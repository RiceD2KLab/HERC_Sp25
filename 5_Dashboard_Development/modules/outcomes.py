...
from utils.KNN_Outcome_Plots import plot_staar, plot_selections, plot_ccmr_rates, plot_graduation_rate_bar, plot_attendance_rate_bar, plot_chronic_absenteeism_bar, plot_dropout_rates, plot_exclusive_staar_with_filters
import plotly.graph_objs as go

map_outcome_plot_functions = {
    #'STAAR Testing': plot_staar,
...
def outcome_ui():
    return ui.nav_panel("Understand outcomes", 
        ...
        ui.card(
            ui.p("If no bars appear, it means that data is not available for that combination of variables. Please try selecting a different variable to explore available data.")
        ),
        value="panel2"
    )
