...
# Local Imports
from AppUtils import title_case_with_spaces, clean_column
...
# =============================================================================
# 2. Demographic Plot Functions
# =============================================================================
# Note the docstrings will be the same except for the description moving forward. 
#Parameters, and returns will be left out in the remaining visualizations

# --- RACE ETHNICITY STACKED BAR PLOT ---
...
# --- SPECIAL EDUCATION 504 BAR PLOT ---
...
# --- STUDENT-TEACHER RATIO DOT STACK ---
...
# --- STAFF STUDENT COUNTS DUMBBELL PLOT ---
...
# --- SELECT DROPDOWN SPECIAL POPULATIONS BAR PLOT ---
...
# --- ECONOMICALLY DISADVANTAGED BAR PLOT ---
